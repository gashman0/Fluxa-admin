          ...
          <div className="relative z-10 flex w-full flex-col justify-between p-12 xl:p-16">
            ...
            <div className="max-w-xl">
              ...
              <p className="mt-6 max-w-lg text-base leading-7 text-white/50 xl:text-lg">
                We've added an extra layer of security to protect the Fluxa
                administration platform and the data it manages.
              </p>
            ...
            <div className="mt-10 rounded-xl border border-[#2d120d]/8 bg-[#2d120d]/[0.025] p-4">
              <div className="flex gap-3">
                ...
                <p className="text-xs leading-5 text-[#2d120d]/50">
                  Never share your verification code with anyone. Fluxa
                  administrators will never ask you for this code.
                </p>
              </div>
            </div>
