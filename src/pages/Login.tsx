...
const Login = () => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        // Temporary
        // We will connect this to the authentication API later.
        setTimeout(() => {
            setIsLoading(false);
        }, 1500);
        navigate('/otp');
                    ...
                    <div className="relative z-10 flex w-full flex-col justify-between p-12 xl:p-16">
                        ...
                        <div className="max-w-xl">
                            ...
                            <p className="mt-6 max-w-lg text-base leading-7 text-white/50 xl:text-lg">
                                A centralized workspace for managing jobs,
                                users, applications, reports and the systems
                                behind the Fluxa platform.
                            </p>
                    ...
                    <div className="w-full max-w-md">
                        ...
                        <div>
                            ...
                            <p className="mt-3 text-sm leading-6 text-[#2d120d]/50">
                                ...
                                continue to the Fluxa Admin Console.
                            </p>
                        </div>
                        ...
                        >
                            ...
                            <label className="flex cursor-pointer items-center gap-3">
                                ...
                                <span className="text-sm text-[#2d120d]/60">
                                    Remember me
                                </span>
                            </label>
                        ...
                        <div className="mt-8 rounded-xl border border-[#2d120d]/8 bg-[#2d120d]/[0.025] p-4">
                            <div className="flex gap-3">
                                ...
                                <p className="text-xs leading-5 text-[#2d120d]/50">
                                    ...
                                    Your activity may be monitored and
